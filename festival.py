...
assert os.environ['SPOTIPY_CLIENT_ID'] != 'YOUR_CLIENT_ID', "Please change the client ID to your own"
assert os.environ['SPOTIPY_CLIENT_SECRET'] != 'YOUR_CLIENT_SECRET', "Please change the client secret to your own"
...
if token:
    ...
    liked_artists = [artist for artist in artist_list if any(artist in song['artists'] for song in liked_songs)]
    ...
    print(f"Successfully created playlist '{playlist_name}' with top songs of liked artists.")
else:
